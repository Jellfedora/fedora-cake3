...
<body ng-controller="appController">
    ...
    <div ng-controller="menuController">
        ...
        <div class="site-title tlt" ng-if="!showMenu" style="color:white; font-weight:bold; text-transform:uppercase; ">
            <h1>Valhalla</h1>
        </div>
        <div class="menu" ng-if="showMenu">
            <div class="menu__links">
                ...
                ?>
                <?= $this->Html->link(
                    $this->Html->image('icons/icon-register.png', array('alt' => "Deconnexion")),
                    array('controller' => 'Users', 'action' => 'logout'),
                    array(
                        'class' => 'menu__links-link',
                        'escape' => false
