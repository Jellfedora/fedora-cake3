...
<div ng-controller="battleController">
    <div class="battle container-fluide text-light text-center"
        style="background-image: url(../img/battle-background/arene-1.png);" ng-controller="secondBattleController"
        ng-init="loadHero()">
        <div class="battle__introduction" ng-show="!hideIntroduction">
            ...
            <span class="battle__introduction__next" id="close"><i class="fa fa-arrow-right fa-2x" aria-hidden="true"
                    ng-click="buttonIntroduction()"></i></span>
        </div>
        <!-- Menu partie -->
        <div class="battle__options text-center" ng-hide="!showBattleMenu">
            ...
            <span class="battle__options-options"><i class="fa fa-refresh fa-2x" aria-hidden="true"></i>
                ...
                ?></span>
            <span class="battle__options-options" id="auto"><i class="fa fa-bed fa-2x"
...
<!-- Player audio -->
<audio class="d-none audio-player" src="../webroot/files/battle-wontolla-are-you-with-us.mp3" controls
    id="battle"></audio>
