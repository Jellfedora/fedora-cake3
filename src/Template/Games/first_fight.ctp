...
<div ng-controller="battleController">
    <div class="battle container-fluide text-light text-center"
        ...
        <div class="battle__map">
            ...
            <div class="battle__map__player-two-avatar">
                ...
                <div class="battle__map__player-two-avatar__sprites sprites-player2" id="playerTwoAvatar"></div>
                <div class="battle__map__player-two-avatar__bar">
                    <div class="player-two-hp player-two-progress-bar">
                        <div class="player-two-hp-bar player-hp-bar"></div>
                    </div>
                    <div class="battle__map__player-two-avatar__life">
                        <span id="j2-hp"><?= $soldier->hp ?></span>
                        /
                        <span id="j2initiaux-hp"> <?= $soldier->hp ?></span>
                    </div>
                    <span class="d-none" id="j2-power">
                        <?= $soldier->attaque ?></span>
                </div>
            </div>
        </div>
        <div class="battle__menu">
            <div class="battle__menu__player">
                <div class="battle__menu__player__content">

                    <div class="battle__menu__player__content__avatar">
                        {{hero_name}}
                    </div>
                    <div class="battle__menu__player__content__stats">
                        <!-- <div >
                            
                        </div> -->
                        <div class="battle__menu__player__content__stats__bar">
                            <div class="player-one-hp progress-bar">
                                <div class="player-one-hp-bar player-hp-bar">
                        ...
                        <div class="battle__menu__player__content__stats__infos">
                            <div>
                                <?= $this->Html->image(
                                    'icons/icon-sword.png',
                                    array('class' => 'battle__menu__player__content__stats__infos__attq'),
                                    array('alt' => "Attaque")
                                ); ?>
                                <span id="j1-attaque">
                                    {{hero_attaque}}</span>
                            ...
                            <div>
                                <?= $this->Html->image(
                                    ...
                                    array('class' => 'battle__menu__player__content__stats__infos__level'),
                                    array('alt' => "Level")
                                ); ?>
                                <span id="j1-level">
                                    {{hero_level}}</span>
                            ...
                            <div>
                                <?= $this->Html->image(
                                    ...
                                    array('class' => 'battle__menu__player__content__stats__infos__potions'),
                                    array('alt' => "Soin")
                                ); ?>
                                <span id="j1-potion">
                                    {{hero_potion}}</span>
    ...
    <audio class="d-none audio-player" src="../webroot/files/battle-Two-steps-from-hell-victory.mp3" controls
        id="battle"></audio>
    <audio class="d-none audio-player" src="../webroot/files/monster-roars.mp3" controls id="monster-roars"></audio>
